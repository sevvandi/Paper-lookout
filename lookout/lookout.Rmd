...
\begin{figure}
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/simplicial_complex.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/four_plots_diff_radi.png}
...
\begin{figure}[!ht]
    \centering
			\includegraphics[width=0.48\textwidth]{lookout_files/figure-html/barcode.png}
        \label{fig:barcodeandpersistence1}
			\includegraphics[width=0.48\textwidth]{lookout_files/figure-html/persistence.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/TDA_and_KNN.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/circles_and_kernels.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/Outlier_Persistence.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/persistence_alpha.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.7]{lookout_files/figure-html/Persistence_Ex1.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/Comparison_Ex1.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/Comparison_Ex2.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.8]{lookout_files/figure-html/Comparison_Ex3.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.7]{lookout_files/figure-html/lvplots.png}
